@if(session()->has('message'))
    <div class="bg-contrast text-center py-4 lg:px-4">
        <div class="p-2 bg-white/20 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
